<%-- 
    ...
    Created on : 10 May 2025, 7:27:57?am
    Author     : wanmu
--%>
...
<div class="container">
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <a class="btn" href="edit.jsp?id=<%= rs.getInt("id") %>&table=users">Edit</a>
                <a class="btn" href="delete.jsp?id=<%= rs.getInt("id") %>&table=users" onclick="return confirm('Delete this user?');">Delete</a>
            </td>
        </tr>
        <%
                }
