<%-- 
    ...
    Created on : 6 May 2025, 7:44:01?am
    Author     : wanmu
--%>
...
<%
    ...
    try {
        ...
        String query = "SELECT b.user_id, u.full_name, b.seat_class, s.departure_time, s.arrival_time, t.train_name, p.amount, p.method " +
                       "FROM bookings b " +
...
<div class="summary-container">
    ...
    <div class="summary-item"><strong>Total Amount Paid:</strong> RM<%= amount %></div>
</div>
</body>
</html>
